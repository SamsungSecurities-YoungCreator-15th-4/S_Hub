...
from engine.evaluation.calibration_schema import CalibrationRecord, validate_official_case_set
...
def compare_versions(
    ...
    from engine.evidence.schema import evalset_hash  # noqa: PLC0415
