...
from engine.evaluation.calibration_schema import (
    CalibrationRecord,
...
from engine.evaluation.judge_calibration import (
...
from engine.judge.axes import to_ko
...
class TestCompareVersions:
    ...
    def test_evalset_hash_is_carried_and_matches_both_sides(self, records_v1):
        ...
        개선으로 귀속할 수 없다.
        """
        from engine.evidence.schema import evalset_hash
...
def test_build_judge_result_accepts_real_judge_eval_output(monkeypatch):
    ...
    """
    monkeypatch.setattr(
        "engine.llm.audit.model_version_record",
