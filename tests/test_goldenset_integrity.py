...
def test_axis_strings_match_code_ssot():
    ...
    axes_mod = pytest.importorskip("engine.judge.axes")
...
LOADER_CANDIDATES = (
    ("engine.evaluation.goldenset_loader", ("load_case", "load_judge_state", "build_state")),
    ("engine.goldenset.loader", ("load_case",)),
