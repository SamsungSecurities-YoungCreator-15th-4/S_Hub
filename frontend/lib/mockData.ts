...
/**
 * 지난 상담 목록. 제목에 고객 이름이 들어가며, 화면은 선택한 고객 것만 보여준다
 * (`demoConsultationList`).
 *
 * 상담 전 고객(isNew)의 기록은 여기 두지 않는다 — 목록에 이름이 있으면 "신규라
 * 비어 있습니다" 라는 화면과 정면으로 어긋난다.
 */
export const PAST_CONSULTATIONS: PastConsultation[] = [
  { id: "pc-1", title: "20260821_이사조_상담기록" },
  { id: "pc-2", title: "20260612_이사조_상담기록" },
  { id: "pc-3", title: "20260305_이사조_상담기록" },
  { id: "pc-4", title: "20260730_박기업_상담기록" },
  { id: "pc-5", title: "20260418_박기업_상담기록" },
];
...
export const IPS_DEFAULT = {
  ...
  timeYears: 22,
  tax: "ISA 비과세·분리과세 · 연금계좌 세액공제",
  liquidity: "중간" as "낮음" | "중간" | "높음",
  legal: "3년 뒤 전세 재계약 및 보증금 인상 예정",
  unique:
...
export const INSIGHT = {
  ...
  defaultAnswer:
    "현재 고객 포트폴리오는 국내주식 20%, 해외배당주 22% 비중으로 선진국 배당 자산에 상대적으로 집중되어 있습니다. 최근 미 연준의 금리 동결 기조 장기화 가능성을 고려할 때, 단기 채권 듀레이션을 1~2년 이내로 유지하면서 투자등급 회사채 비중을 소폭 확대하는 전략이 유효합니다.\n\n환율 측면에서는 원/달러 환율이 1,380~1,420원 구간에서 등락하는 현 상황에서, 해외자산 중 비헤지 비중이 44%에 달해 환손실 리스크가 잠재합니다. 달러 익스포저의 30% 수준까지 환헤지 전환을 단계적으로 검토하시기 바랍니다.\n\n세후 수익률 기준으로는 안정 추구 안(세후 5.5%)가 현재 포트폴리오(세후 4.0%) 대비 약 1.5%p 우위에 있으며, ISA 계좌 편입과 연금저축 한도 추가 납입을 통해 절세 여력이 연간 최대 1,080만원 추가로 확보 가능합니다.\n\n리스크 관리 측면에서 MDD -11.2% 수준은 고객 손실 허용 범위(통상 -15% 이내) 내에 있으나, 글로벌 경기 둔화 시나리오 하에서 해외성장주 비중(12%)이 변동성 확대의 주요 원인이 될 수 있습니다. 수익 추구 안의 해외성장주 22% 비중 확대안은 고수익 추구 성향 고객에 한해 선별 제안을 권고합니다.",
  /**
