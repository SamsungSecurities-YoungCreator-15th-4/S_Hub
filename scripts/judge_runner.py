...
from engine.evaluation.calibration_schema import build_judge_result  # noqa: E402
...
from engine.evaluation.goldenset_loader import load_case  # noqa: E402,F401
...
def _trace_url(run_id: uuid.UUID, project: str) -> str | None:
    ...
    if not (endpoint and api_key and project):
        return None
    from engine.observability.langsmith import _get_run_url
...
def _load_r1_cases() -> list[dict]:
    ...
    """
    from engine.evaluation.goldenset_loader import load_all_cases
...
def _r1_input_set_hash() -> str:
    ...
    from engine.evaluation.goldenset_loader import input_set_hash
...
def _langsmith_project() -> str | None:
    ...
    """
    from engine.observability.langsmith import langsmith_enabled
